...
public class CustomStageActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        OnDragListener dragListener = new OnDragListener() {
            @Override
            public void
                    onDragOver(View target, DragSource source, int x, int y, int xOffset, int yOffset,
                            DragView dragView, Object dragInfo) {
            }

            @Override
            public void
                    onDragExit(View target, DragSource source, int x, int y, int xOffset, int yOffset,
                            DragView dragView, Object dragInfo) {
            ...
            @Override
            public void onDragEnter(View target, DragSource source, int x, int y, int xOffset, int yOffset,
                    DragView dragView,
                    Object dragInfo) {
                Integer id = textIdByDropTarget.get(target);
        ...
        trashCan.setOnDropListener(new OnDropListener() {
            @Override
            public void onDrop(View target, DragSource source, int x, int y, int xOffset, int yOffset,
                    DragView dragView,
                    Object dragInfo) {
        ...
        pencil.setOnDropListener(new OnDropListener() {
            @Override
            public void onDrop(View view, DragSource source, int x, int y, int xOffset, int yOffset, DragView dragView,
                    Object dragInfo) {
                CustomLevel level = ((CustomLevelGridCell) source).getLevel();
                if (level.isImported()) {
                    Toast.makeText(CustomStageActivity.this, R.string.cannot_edit_imported_levels, Toast.LENGTH_SHORT)
                            .show();
                    return;
                }

                Intent levelIntent = new Intent(CustomStageActivity.this, CustomPuzzleBuilderActivity.class);
                levelIntent.putExtra(CustomPuzzleBuilderActivity.LEVEL_ID, level.getDbId());
        ...
        adapter = new ArrayAdapter<Level>(getApplication(),
            ...
            public View getView(int position, View inputRow, ViewGroup parent) {
                ...
                if (inputRow == null) {
                    row = (CustomLevelGridCell) getLayoutInflater().inflate(R.layout.level_select_grid_item,
                            parent, false);
                } else {
                ...
                final Button levelButton = (Button) row.findViewById(R.id.level_name);
                ...
                if (isImported) {
                    ...
                    row.findViewById(R.id.byLabel).setVisibility(View.INVISIBLE);
        ...
        back.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent levelIntent = new Intent(CustomStageActivity.this, ChooseStageActivity.class);
                startActivity(levelIntent);
        ...
        buildCustom.setOnDropListener(new OnDropListener() {
            ...
            public void onDrop(View view, DragSource source, int x, int y, int xOffset, int yOffset, DragView dragView,
                ...
                CustomLevel level = ((CustomLevelGridCell) source).getLevel();
                if (level.isImported()) {
                    Toast.makeText(CustomStageActivity.this, R.string.cannot_copy_imported_levels, Toast.LENGTH_SHORT)
                            .show();
                    return;
                }
    ...
    private void shareLevel(final CustomLevel level) {
        ...
        try {
            ...
            SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(CustomStageActivity.this);
            String defaultText = CustomStageActivity.this.getString(R.string.default_custom_level_share_message);
            String shareText = preferences.getString(
                    CustomStageActivity.this.getString(R.string.pref_default_share_custom_level_key),
                    defaultText);

            shareText = shareText.replaceAll("%a", author);
            shareText = shareText.replaceAll("%u", "http://www.oakonell.com/findx/share/" + encodedString);
            shareText = shareText.replaceAll("%l", title + "\n "
            ...
            Toast.makeText(getApplicationContext(),
                    "Encountered an exception trying to share the level:" + e.getLocalizedMessage(),
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            edit.putString(getString(R.string.pref_share_author_key), author);
                            edit.commit();
                            dialog.dismiss();
                            runnable.run();
                        }
    ...
    private void startPuzzle(final String levelId) {
        Intent levelIntent = new Intent(CustomStageActivity.this, PuzzleActivity.class);
    ...
    protected void deleteLevel(final CustomLevel level) {
        ...
        alertDialog
                .setMessage(getResources().getString(R.string.confirm_delete_level_text,
