...
public class CustomLevelGridCell extends LinearLayout implements DragSource,
		DropTarget {
	...
	public void onDrop(DragSource source, int x, int y, int xOffset,
		...
		if (onDropListener != null) {
			onDropListener.onDrop(this, source, x, y, xOffset, yOffset,
					dragView, dragInfo);
		}
	}
	...
	public void setLevel(ICustomLevel level) {
		this.level = level;
	}

	public ICustomLevel getLevel() {
		return level;
	}
