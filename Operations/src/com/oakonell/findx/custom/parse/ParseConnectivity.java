...
import com.oakonell.findx.custom.PromptNicknameFragment;
...
public class ParseConnectivity {
	...
	public interface ParseUserExtra {
	...
	public static void createUniqueNickname(FragmentActivity context,
	...
	public static boolean modifyNickName(String nick) {
		...
		userQuery.whereEqualTo(ParseUserExtra.nickname_field, nick);
		...
		currentUser.put(ParseUserExtra.nickname_field, nick);
		try {
			currentUser.save();
		} catch (ParseException e) {
