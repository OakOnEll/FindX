...
public class SharedLevelActivity extends Activity {
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            String encodedString = path.substring(indexOf + pathPrefix.length());
            byte[] bytes = Base64.decode(encodedString, Base64.URL_SAFE | Base64.NO_WRAP);
            String xmlString = Utils.decompress(bytes);

            Document doc = DocumentBuilderFactory.newInstance().newDocumentBuilder()
                    .parse(new InputSource(new StringReader(xmlString)));
            Element root = doc.getDocumentElement();
            String title = XMLUtils.getTextContent(XMLUtils.getChildElementByName(root, "t"));
            String author = XMLUtils.getTextContent(XMLUtils.getChildElementByName(root, "a"));
            List<Element> operationElems = XMLUtils.getChildElementsByName(root, "o");
            List<Operation> operations = new ArrayList<Operation>();
            for (Element each : operationElems) {
                String typeString = XMLUtils.getTextContent(XMLUtils.getChildElementByName(each, "t"));
            ...
            equationView.setText(builder.getMoves().get(0).getStartEquation().toString());
            ...
            importButton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    CustomLevel level = Levels.getCustomStage().getLevelByDBId(builder.getId());
            ...
            ((TextView) findViewById(R.id.title)).setText(e.getLocalizedMessage());
        }
    }
    ...
    private void startPuzzle(final String levelId) {
        Intent levelIntent = new Intent(SharedLevelActivity.this, PuzzleActivity.class);
