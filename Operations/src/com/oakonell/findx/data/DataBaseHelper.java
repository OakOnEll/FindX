...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        createTableString = "CREATE TABLE " + CUSTOM_LEVEL_OPERATIONS_TABLE_NAME +
                " (" +
                BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (newVersion == 7) {
            db.execSQL("ALTER TABLE " + CUSTOM_LEVEL_TABLE_NAME + " ADD COLUMN " + CustomLevelTable.AUTHOR
                    + " STRING;");
            return;
        }
        ...
        db.execSQL("DROP TABLE IF EXISTS " + CUSTOM_LEVEL_OPERATIONS_TABLE_NAME + ";");
