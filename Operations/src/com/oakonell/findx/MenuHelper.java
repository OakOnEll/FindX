...
public class MenuHelper {
    ...
    public static boolean onCreateOptionsMenu(Context context, Menu menu) {
        MenuItem settingsItem = menu.add(Menu.NONE, MENU_SETTINGS_ID, Menu.NONE, R.string.menu_settings);
    ...
    public static boolean onOptionsItemSelected(Context context, MenuItem item) {
        switch (item.getItemId()) {
            ...
            default:
                throw new RuntimeException("Invalid options item " + item.getItemId());
        }
    }
