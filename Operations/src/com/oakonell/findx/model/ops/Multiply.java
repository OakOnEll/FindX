...
public class Multiply extends AbstractOperation {
    ...
    public Expression apply(Expression expression) {
        Fraction xCoeff = OptimizedFractionUtils.multiply(expression.getXCoefficient(), factor);
        Fraction constant = OptimizedFractionUtils.multiply(expression.getConstant(), factor);
