...
public class Divide extends AbstractOperation {
    ...
    public Expression apply(Expression expression) {
        Fraction xCoeff = OptimizedFractionUtils.divide(expression.getXCoefficient(), factor);
        Fraction constant = OptimizedFractionUtils.divide(expression.getConstant(), factor);
