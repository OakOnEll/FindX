...
public class Subtract extends AbstractOperation {
    ...
    public Expression apply(Expression expression) {
        Fraction xCoeff = OptimizedFractionUtils.subtract(expression.getXCoefficient(), expr.getXCoefficient());
        Fraction constant = OptimizedFractionUtils.subtract(expression.getConstant(), expr.getConstant());
