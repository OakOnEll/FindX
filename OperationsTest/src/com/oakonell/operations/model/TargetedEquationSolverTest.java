...
public class TargetedEquationSolverTest extends TestCase {
    public void testSolverLevel0() {
        ...
        try {
            ...
            moves = solver.solve(level.getEquation(), new Equation(new Expression(1, 0), new Expression(1)),
                    level.getOperations(), level.getMinMoves());
    ...
    public void testSolverLevel1() {
        ...
        try {
            ...
            TargetedEquationSolver solver = new TargetedEquationSolver();
            moves = solver.solve(level.getEquation(), new Equation(new Expression(1, 0), new Expression(4)),
                    level.getOperations(), level.getMinMoves());
    ...
    public void testSolverLevel2() {
        ...
        try {
            ...
            TargetedEquationSolver solver = new TargetedEquationSolver();
            moves = solver.solve(level.getEquation(), new Equation(new Expression(1, 0), new Expression(9)),
                    level.getOperations(), level.getMinMoves());
    ...
    public void testSolverLevel3() {
        ...
        try {
            ...
            // // x + 1 = 9
            TargetedEquationSolver solver = new TargetedEquationSolver();
            moves = solver.solve(level.getEquation(), new Equation(new Expression(1, 0), new Expression(8)),
                    level.getOperations(), level.getMinMoves());
    ...
    public void testSolverLevel5() {
        ...
        try {
            ...
            TargetedEquationSolver solver = new TargetedEquationSolver();
            moves = solver.solve(level.getEquation(), new Equation(new Expression(1, 0), new Expression(2)),
                    level.getOperations(), level.getMinMoves());
            assertEquals(5, moves.size());
            assertEquals(level.getMinMoves(), moves.size());
            Iterator<Move> iter = moves.iterator();
    ...
    public void testSolverLevel6() {
        ...
        try {
            ...
            TargetedEquationSolver solver = new TargetedEquationSolver();
            moves = solver.solve(level.getEquation(), new Equation(new Expression(1, 0), new Expression(10)),
                    level.getOperations(), level.getMinMoves());
    ...
    public void testSolverLevel7() {
        ...
        try {
            ...
            TargetedEquationSolver solver = new TargetedEquationSolver();
            moves = solver.solve(level.getEquation(), new Equation(new Expression(1, 0), new Expression(-3)),
                    level.getOperations(), level.getMinMoves() + 1);
            assertEquals(4, moves.size());
            assertEquals(level.getMinMoves(), moves.size());
            Iterator<Move> iter = moves.iterator();
            assertEquals("Subtract 1", iter.next().getOperation().toString());
    ...
    public void testSolverLevel8() {
        ...
        try {
            ...
            TargetedEquationSolver solver = new TargetedEquationSolver();
            moves = solver.solve(level.getEquation(), new Equation(new Expression(1, 0), new Expression(Fraction.ZERO,
                    new Fraction(3))),
                    level.getOperations(), level.getMinMoves());
            assertEquals(5, moves.size());
            assertEquals(level.getMinMoves(), moves.size());
    ...
    public void testSolverLevel10() {
        ...
        for (int i = 0; i < 13; i++) {
            ...
            TargetedEquationSolver solver = new TargetedEquationSolver();
            List<Move> moves = solver.solve(level.getEquation(), new Equation(new Expression(1, 0), new Expression(6)),
    ...
    public void testSolverLevel11() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            List<Move> moves = solver.solve(level.getEquation(),
                    new Equation(new Expression(1, 0), new Expression(-3)),
                    level.getOperations(), i);
            System.out.println("Depth " + i + ": " + TimeUnit.NANOSECONDS.toMillis(System.nanoTime() - start) + " ms");
            try {
                if (moves == null) {
...
//    public void testSolverLevel13() {
//        Level level = Levels.get("3-1");
//
//        long start = System.nanoTime();
//        TargetedEquationSolver solver = new TargetedEquationSolver();
//        List<Move> moves = solver.solve(level.getEquation(),
